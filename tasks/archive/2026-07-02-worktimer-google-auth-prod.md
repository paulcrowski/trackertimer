...
Closed At: 2026-07-02T19:19:31.733Z
Result: PASS
Source File: tasks/todo.md

# Current Task

Task ID: 2026-07-02-worktimer-google-auth-prod
...
## Cel / Outcome
Przywrócić Google auth dla worktimer tak, aby to samo konto działało na wielu urządzeniach na osobnym deployu Cloudflare + Convex.

## Kryteria sukcesu
- worktimer używa Google auth na prod

## Priorytet / Blocker
Największy blocker teraz: Przywrócić Google auth dla worktimer tak, aby to samo konto działało na wielu urządzeniach na osobnym deployu Cloudflare + Convex.
...
## Zakres
Moduł: auth+convex+cloudflare
Pliki: tasks/todo.md, convex/auth.ts, convex/_generated/api.d.ts, src/App.tsx, src/components/SessionDialogs.tsx, src/lib/tracker.ts, index.html, tests/app.test.tsx
...
## Granice
Moduły dotknięte: auth+convex+cloudflare
