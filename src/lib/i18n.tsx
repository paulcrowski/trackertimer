...
const polish: Record<string, string> = {
  ...
  'Scanning active app and window title outside this window.': 'Skanuje aktywną aplikację i tytuł okna poza tym oknem.',
  ...
  'This prepares separate entries in the stop dialog; nothing is saved until you confirm.': 'To przygotowuje osobne wpisy w oknie kończenia sesji; nic nie zapisze się bez Twojego potwierdzenia.',
  ...
  'Signal is treated as private time. YouTube, Instagram, Tinder, Reddit, Wykop and X are treated as distractions and count as focus losses. You can still correct every block before saving.': 'Signal jest traktowany jako czas prywatny. YouTube, Instagram, Tinder, Reddit, Wykop i X są traktowane jako rozproszenia i liczą się jako utrata skupienia. Każdy blok możesz poprawić przed zapisaniem.',
  ...
  'Standard — mask sensitive text in window titles': 'Standardowy — maskuj wrażliwy tekst w tytułach okien',
  'High — store app only': 'Wysoki — zapisuj tylko aplikację',
  'Private domains always hide their domain and title.': 'Prywatne domeny zawsze ukrywają domenę i tytuł.',
  'At High privacy, browser domains are hidden, so YouTube, Instagram and similar sites cannot be identified as distractions.': 'Przy wysokiej prywatności domeny przeglądarki są ukryte, więc YouTube, Instagram i podobne strony nie zostaną rozpoznane jako rozproszenia.',
  'Short helper fragments found': 'Znaleziono krótkie fragmenty helpera',
  'These entries share the same context and are close together. Review before merging; nothing is changed automatically.': 'Te wpisy mają ten sam kontekst i są blisko siebie. Sprawdź je przed scaleniem; nic nie zmieni się automatycznie.',
